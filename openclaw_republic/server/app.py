...
async def lifespan(app: FastAPI) -> AsyncGenerator[None, None]:
    ...
    async def _db_bridge(event: BaseEvent) -> None:
        ...
        try:
            ...
            if event.action in (EventAction.CONSTITUTIONAL, EventAction.UNCONSTITUTIONAL) and "verdict" in event_raw_payload:
                ...
                await state.task_store.store_verdict(event.task_id, constitutional, ruling, evidence)
