        ...
        while True:
            ...
            if data == "ping":
                ...
                try:
                    ...
                    if action == "new_task":
                        ...
                        if prompt:
                            ...
                            try:
                                ...
                                await conn.execute("DELETE FROM verdicts WHERE task_id = ?", (task_id,))
                            ...
                            await state.task_queue.submit(task_id, _run_petition(task_id, prompt, state))
                    ...
                    logger.error(f"[WS Client] Parse error inside connection loop: {e}", exc_info=True)
